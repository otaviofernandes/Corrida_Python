...
pygame.display.set_caption('Corrida em Python') #mostra nome do jogo na janela
...
while janela_aberta:
    ...
    if (xp < x2 +100 and yp < y2 + 169) and (xp + 100 > x2 and yp < y2 + 169): #colisão com carro npc 2
        break
    if (xp < x4 +100 and yp < y4 + 169) and (xp + 100 > x4 and yp < y4 + 169): #colisão com carro npc 2
        break
    #-----------------------------------------------------------------------------------
    y1 += veloc_x1
    if y1 > 680:
